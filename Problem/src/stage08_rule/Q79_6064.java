 ...
 * */
/**
 * 참고) http://mygumi.tistory.com/325
 * 그냥 풀면 시간초과. x를 먼저 맞추고, y만을 신경쓴다.
 * y는 M만큼 증가하고 N으로 나머지 연산을 한다면, y의 값을 알 수 있다. 마지막 해는 최소공배수
 * */
public class Q79_6064 {
