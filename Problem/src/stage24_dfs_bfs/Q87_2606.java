...
public class Q87_2606 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i=0 ; i<pair ; i++){
            ...
            network[Integer.parseInt(input[0])-1][Integer.parseInt(input[1])-1] = 1;
            network[Integer.parseInt(input[1])-1][Integer.parseInt(input[0])-1] = 1;
        }
    ...
    private static void dfs(int computer){
      ...
      for(int i=0 ; i<visit.length ; i++){
          if(network[computer][i]==1 && !visit[i]){
